...
class App{
  ...
  } //Bind zato sto u callback function this je undifend
  ...
  _newWorkout(e){
     ...
     if(type === 'running'){
       const cadence =+ inputCadence.value;
        if(!valid(duration,distance,cadence)){
          return alert("Input type has to be positive number!");
        }
     ...
     if(type === 'cycling'){
        ...
        if(!valid(duration,distance,elevation)){
          return alert("Input type has to be positive number!");
        }
